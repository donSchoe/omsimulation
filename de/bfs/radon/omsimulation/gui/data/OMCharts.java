...
public abstract class OMCharts {
  ...
  public static JFreeChart createDistributionChart(String title,
    ...
    ValueMarker medMarker = new ValueMarker(distValues[pos], new Color(0, 0,
        255, 128), new BasicStroke(1, BasicStroke.CAP_BUTT,
        BasicStroke.JOIN_MITER, 1, dash, 0));
    ...
    percentiles.setPaint(new Color(222, 222, 255, 128));
